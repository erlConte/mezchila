    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 mb-12 sm:mb-16">
          <span className="font-serif text-[11px] text-olive/70 tabular-nums">06</span>
          <div className="w-6 h-[1px] bg-olive/40" />
          <span className="text-[11px] font-medium uppercase tracking-[0.2em] text-ivory/35">Manifesto</span>
        </div>
